...
| 1.3 | Create DashboardServer class (FastAPI app, uvicorn task, death watchdog) | Not Started | 1.2 | `dashboard/server.py` |
...
| 1.9 | Add startup WARNING log if host != 127.0.0.1 | Not Started | 1.3 | `dashboard/server.py` |
